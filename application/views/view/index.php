  ...
  <section id="container" >
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a href="<?= base_url('Welcome/kelola_data')?>" >
                          <i class="fa fa-cogs"></i>
     ...
     <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Your Profile </h3>
          	<div class="row mt">
          		<div class="col-lg-12">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <label class="col-sm-2 col-sm-2 control-label"><?=$this->session->userdata('username')?></label>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nama User</label>
                              <div class="col-sm-10">
                                  <label class="col-sm-2 col-sm-2 control-label"><?=$this->session->userdata('nama_user')?></label>
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Level</label>
                              <div class="col-sm-10">
                                  <label class="col-sm-2 col-sm-2 control-label"><?=$this->session->userdata('level')?></label>
                              </div>
                          </div>
                      </form>
                  </div>
